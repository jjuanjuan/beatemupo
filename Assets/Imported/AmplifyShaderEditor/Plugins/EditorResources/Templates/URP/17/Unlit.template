	...
	SubShader
	{
		...
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Fragment Normal Space,InvertActionOnDeselection:Tangent,Object,World:Tangent
				...
				Tangent:SetPortName:Forward:9,Normal
				Object:SetDefine:_NORMAL_DROPOFF_OS 1
				Object:SetPortName:Forward:9,Object Normal
				World:SetDefine:_NORMAL_DROPOFF_WS 1
				World:SetPortName:Forward:9,World Normal
			Option:Forward Only:false,true:false
				false,disable:SetPropertyOnPass:Forward:RemoveTag,LightMode
				false,disable:SetPropertyOnPass:DepthNormals:ChangeTagValue,LightMode,DepthNormals
				false,disable:IncludePass:GBuffer
				true:SetPropertyOnPass:Forward:AddTag,LightMode,UniversalForwardOnly
			...
			Option:Receive SSAO:false,true:true
				...
				true:SetDefine:Forward:UNLIT_DEFAULT_SSAO
				...
				false:RemoveDefine:Forward:UNLIT_DEFAULT_SSAO
			Option:Default Decal Blending:false,true:true
				true:SetDefine:Forward:UNLIT_DEFAULT_DECAL_BLENDING
				true:SetDefine:GBuffer:UNLIT_DEFAULT_DECAL_BLENDING
				false:RemoveDefine:Forward:UNLIT_DEFAULT_DECAL_BLENDING
				false:RemoveDefine:GBuffer:UNLIT_DEFAULT_DECAL_BLENDING
		...
		*/
		...
		Pass
		{
						...
						/*ase_frag_input*/ ) : SV_Target
			{
				...
				float3 Normal = /*ase_frag_out:Normal;Float3;9;-1;_FragNormal*/float3(0, 0, 1)/*end*/;
		...
		Pass
		{
			...
			struct PackedVaryings
			{
				...
				/*ase_interp(2,):sp=sp;wn=tc0.xyz;wt=tc1*/
				UNITY_VERTEX_INPUT_INSTANCE_ID
				UNITY_VERTEX_OUTPUT_STEREO
			};
